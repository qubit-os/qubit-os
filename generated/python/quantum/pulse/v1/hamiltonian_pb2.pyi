...
class HamiltonianSpec(_message.Message):
    ...
    def __init__(self, format: _Optional[_Union[HamiltonianSpec.RepresentationFormat, str]] = ..., content: _Optional[str] = ..., hilbert_space_dim: _Optional[int] = ..., num_qubits: _Optional[int] = ..., validation_tolerance: _Optional[float] = ..., control_operators: _Optional[_Iterable[str]] = ..., validated: _Optional[bool] = ..., validation_error: _Optional[str] = ...) -> None: ...
