...
class ExecutePulseResponse(_message.Message):
    ...
    def __init__(self, trace: _Optional[_Union[_common_pb2.TraceContext, _Mapping]] = ..., success: _Optional[bool] = ..., error: _Optional[_Union[_common_pb2.Error, _Mapping]] = ..., result: _Optional[_Union[MeasurementResult, _Mapping]] = ..., warnings: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ExecutePulseBatchRequest(_message.Message):
    ...
    def __init__(self, trace: _Optional[_Union[_common_pb2.TraceContext, _Mapping]] = ..., requests: _Optional[_Iterable[_Union[ExecutePulseRequest, _Mapping]]] = ..., stop_on_first_error: _Optional[bool] = ...) -> None: ...
